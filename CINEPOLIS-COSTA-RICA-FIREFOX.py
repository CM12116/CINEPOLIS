...
# Proporciona una manera de usar funcionalidades dependientes del sistema operativo.
import os

# Permite trabajar con tiempo, como pausar la ejecución del programa.
import time

# Ofrece acceso a algunos parámetros y funciones del sistema, útil para manipulación de la línea de comandos.
import sys

# Proporciona clases para manipulación de fechas y horas.
from datetime import datetime

# Permite analizar URLs y extraer sus componentes.
...
# Librería para leer y escribir archivos Excel en formato .xlsx.
import openpyxl 

# Proporciona herramientas para controlar navegadores web mediante Selenium.
from selenium import webdriver

# Permite localizar elementos en la página web usando diferentes estrategias.
from selenium.webdriver.common.by import By 

# Select para manejar listas desplegables, WebDriverWait para esperar condiciones específicas.
from selenium.webdriver.support.ui import Select, WebDriverWait

# Define las condiciones que se esperan en la página antes de continuar.
from selenium.webdriver.support import expected_conditions as EC

# Configura el servicio de WebDriver para el navegador Firefox.
from selenium.webdriver.firefox.service import Service

# Permite configurar opciones adicionales para el navegador Firefox.
from selenium.webdriver.firefox.options import Options



#3. CONFIGURACIÓN DE OPCIONES Y SERVICIO PARA EL NAVEGADOR MOZILLA FIREFOX

# Crea una instancia de opciones para el navegador Firefox.
options_firefox = Options()

# Descomentar para ejecutar Firefox en modo headless (sin interfaz gráfica).
# options_firefox.headless = True


# Configura el servicio de WebDriver para Firefox especificando la ruta al ejecutable de geckodriver.
service_firefox = Service('C:\\Users\\William Monroy\\Desktop\\geckodriver.exe')



# Inicializa el navegador Firefox con las opciones y el servicio configurados.
driver = webdriver.Firefox(service=service_firefox, options=options_firefox)
...
#Crear una nueva hoja en el archivo de Excel
    ...
    # Supone que la URL tiene el formato "https://nombre-del-cine.co.cr/..." 
    cadena_de_cine = url.split("https://")[1].split(".co.cr/")[0].upper()
...
#1  #Cartago, Costa Rica - Cinépolis Paseo Metrópoli

    # Llamada a la función elegir_ciudad_cine para seleccionar una ciudad y un cine específicos
    # valor_ciudad = "11" corresponde al atributo 'value' de una opción en el menú desplegable de ciudades
    # en el HTML, se verá algo como esto:
    # <select id="ciudad">
    #   <option value="11">Ciudad Ejemplo</option>
    #   <!-- Otras opciones -->
    # </select>
    #
    # valor_cine = "251" corresponde al atributo 'value' de una opción en el menú desplegable de cines
    # en el HTML, se verá algo como esto:
    # <select id="cine">
    #   <option value="251">Cine Ejemplo</option>
    #   <!-- Otras opciones -->
    # </select>

    nombre_cine = elegir_ciudad_cine(driver, espera, "11", "251")

   # Se imprime el nombre del cine seleccionado para confirmación.
    print(f"\n\n\n\n\n\nNOMBRE DEL CINE SELECCIONADO (1/8): {nombre_cine}.")
...
#2  #Desamparados, Costa Rica - Cinépolis Multicentro

    # Crea una instancia de WebDriverWait con un tiempo de espera máximo de 10 segundos.
    espera = WebDriverWait(driver, 10)

    # Llamada a la función elegir_ciudad_cine para seleccionar una ciudad y un cine específicos
    # valor_ciudad = "82" corresponde al atributo 'value' de una opción en el menú desplegable de ciudades.
    # En el código HTML se verá algo como esto:
    # <select id="ciudad">
    #   <option value="82">Ciudad Ejemplo</option>
    #   <!-- Otras opciones -->
    # </select>
    #
    # valor_cine = "144" corresponde al atributo 'value' de una opción en el menú desplegable de cines.
    # En el código HTML se verá algo como esto:
    # <select id="cine">
    #   <option value="144">Cine Ejemplo</option>
    #   <!-- Otras opciones -->
    # </select>

    nombre_cine = elegir_ciudad_cine(driver, espera, "82", "144")


   # Se imprime el nombre del cine seleccionado para confirmación.
    print(f"\n\n\n\n\n\nNOMBRE DEL CINE SELECCIONADO (2/8): {nombre_cine}.")
...
#3  #Heredia, Costa Rica - Cinépolis Paseo de Las Flores

    # Crea una instancia de WebDriverWait con un tiempo de espera máximo de 10 segundos.
    espera = WebDriverWait(driver, 10)

    # Llamada a la función elegir_ciudad_cine para seleccionar una ciudad y un cine específicos
    # valor_ciudad = "156" y valor_cine = "438" son valores que corresponden a los atributos 'value'
    # de las opciones dentro de los menús desplegables en el HTML de la página web.

    # En el código HTML, el menú desplegable para seleccionar la ciudad puede verse así:
    # <select id="ciudad">
    #   <option value="156">Nombre de la Ciudad</option>
    #   <!-- Otras opciones -->
    # </select>

    # Y el menú desplegable para seleccionar el cine puede verse así:
    # <select id="cine">
    #   <option value="438">Nombre del Cine</option>
    #   <!-- Otras opciones -->
    # </select>

    # La función elegir_ciudad_cine selecciona la ciudad y el cine basándose en los valores proporcionados,
    # y devuelve el nombre del cine seleccionado en formato mayúsculas.

    nombre_cine = elegir_ciudad_cine(driver, espera, "156", "438")

   # Se imprime el nombre del cine seleccionado para confirmación.
    print(f"\n\n\n\n\n\nNOMBRE DEL CINE SELECCIONADO (3/8): {nombre_cine}.")
...
#4  #Lindora, Costa Rica - Cinépolis VIP Terrazas Lindora
    
    # Crea una instancia de WebDriverWait con un tiempo de espera máximo de 10 segundos.
    espera = WebDriverWait(driver, 10)

    # Llamada a la función elegir_ciudad_cine para seleccionar una ciudad y un cine específicos.
    # valor_ciudad = "178" y valor_cine = "509" son valores que corresponden a los atributos 'value'
    # de las opciones dentro de los menús desplegables en el HTML de la página web.

    # En el HTML, el menú desplegable para seleccionar la ciudad podría verse así:
    # <select id="ciudad">
    #   <option value="178">Nombre de la Ciudad</option>
    #   <!-- Otras opciones -->
    # </select>

    # Y el menú desplegable para seleccionar el cine podría verse así:
    # <select id="cine">
    #   <option value="509">Nombre del Cine</option>
    #   <!-- Otras opciones -->
    # </select>
    ...
    nombre_cine = elegir_ciudad_cine(driver, espera, "178", "509")


    # Se imprime el nombre del cine seleccionado para confirmación.
    print(f"\n\n\n\n\n\nNOMBRE DEL CINE SELECCIONADO (4/8): {nombre_cine}.")
...
#5  #Moravia, Costa Rica - Cinépolis Lincoln
    
    # Crea una instancia de WebDriverWait con un tiempo de espera máximo de 10 segundos.
    espera = WebDriverWait(driver, 10)

    # Llamada a la función elegir_ciudad_cine para seleccionar una ciudad y un cine específicos.
    # valor_ciudad = "174" y valor_cine = "490" son valores que corresponden a los atributos 'value'
    # de las opciones dentro de los menús desplegables en el HTML de la página web.

    # En el HTML, el menú desplegable para seleccionar la ciudad podría verse así:
    # <select id="ciudad">
    #   <option value="174">Nombre de la Ciudad</option>
    #   <!-- Otras opciones -->
    # </select>

    # Y el menú desplegable para seleccionar el cine podría verse así:
    # <select id="cine">
    #   <option value="490">Nombre del Cine</option>
    #   <!-- Otras opciones -->
    # </select>
    ...
    nombre_cine = elegir_ciudad_cine(driver, espera, "174", "490")


    # Se imprime el nombre del cine seleccionado para confirmación.
    print(f"\n\n\n\n\n\nNOMBRE DEL CINE SELECCIONADO (5/8): {nombre_cine}.")
...
#6  #Moravia, Costa Rica - Cinépolis VIP Lincoln
    
    # Crea una instancia de WebDriverWait con un tiempo de espera máximo de 10 segundos.
    espera = WebDriverWait(driver, 10)

    # Llamada a la función elegir_ciudad_cine para seleccionar una ciudad y un cine específicos.
    # valor_ciudad = "174" y valor_cine = "497" son valores que corresponden a los atributos 'value'
    # de las opciones dentro de los menús desplegables en el HTML de la página web.
    ...
    # Y el menú desplegable para seleccionar el cine podría verse así:
    # <select id="cine">
    #   <option value="497">Nombre del Cine</option>
    #   <!-- Otras opciones -->
    # </select>
    ...
    nombre_cine = elegir_ciudad_cine(driver, espera, "174", "497")


    # Se imprime el nombre del cine seleccionado para confirmación.
    print(f"\n\n\n\n\n\nNOMBRE DEL CINE SELECCIONADO (6/8): {nombre_cine}.")
...
#7  #Tres Ríos, Costa Rica - Cinépolis Terramall
    
    # Crea una instancia de WebDriverWait con un tiempo de espera máximo de 10 segundos.
    espera = WebDriverWait(driver, 10)

    # Llamada a la función elegir_ciudad_cine para seleccionar una ciudad y un cine específicos.
    # valor_ciudad = "100" y valor_cine = "264" son valores que corresponden a los atributos 'value'
    # de las opciones dentro de los menús desplegables en el HTML de la página web.

    # En el HTML, el menú desplegable para seleccionar la ciudad podría verse así:
    # <select id="ciudad">
    #   <option value="100">Nombre de la Ciudad</option>
    #   <!-- Otras opciones -->
    # </select>

    # Y el menú desplegable para seleccionar el cine podría verse así:
    # <select id="cine">
    #   <option value="264">Nombre del Cine</option>
    #   <!-- Otras opciones -->
    # </select>
    ...
    nombre_cine = elegir_ciudad_cine(driver, espera, "100", "264")


    # Se imprime el nombre del cine seleccionado para confirmación.
    print(f"\n\n\n\n\n\nNOMBRE DEL CINE SELECCIONADO (7/8): {nombre_cine}.")
...
#8  #Tres Ríos, Costa Rica - Cinépolis VIP Terramall
    
    # Crea una instancia de WebDriverWait con un tiempo de espera máximo de 10 segundos.
    espera = WebDriverWait(driver, 10)

    # Llamada a la función elegir_ciudad_cine para seleccionar una ciudad y un cine específicos.
    # valor_ciudad = "100" y valor_cine = "263" son valores que corresponden a los atributos 'value'
    # de las opciones dentro de los menús desplegables en el HTML de la página web.
    ...
    # Y el menú desplegable para seleccionar el cine podría verse así:
    # <select id="cine">
    #   <option value="263">Nombre del Cine</option>
    #   <!-- Otras opciones -->
    # </select>
    ...
    nombre_cine = elegir_ciudad_cine(driver, espera, "100", "263")


    # Se imprime el nombre del cine seleccionado para confirmación.
    print(f"\n\n\n\n\n\nNOMBRE DEL CINE SELECCIONADO (8/8): {nombre_cine}.")
...
# el código dentro del bloque 'finally' siempre se ejecutará al final.
    ...
    # El nombre del archivo tendrá el formato "CINEPOLIS-COSTA-RICA-YYYY-MM-DD.xlsx", donde YYYY-MM-DD es la fecha actual.
    # Por ejemplo, si hoy es el 12 de agosto de 2024, el nombre del archivo será "CINEPOLIS-COSTA-RICA-2024-08-12.xlsx".
    nombre_archivo = f"CINEPOLIS-COSTA-RICA-{datetime.now().strftime('%Y-%m-%d')}.xlsx"
