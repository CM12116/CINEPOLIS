...
#Crear una nueva hoja en el archivo de Excel
    ...
    # Supone que la URL tiene el formato "https://nombre-del-cine.com.sv/..." 
    cadena_de_cine = url.split("https://")[1].split(".com.sv/")[0].upper()
...
#1  #Cinépolis Galerías San Salvador

    # Llamada a la función elegir_ciudad_cine para seleccionar una ciudad y un cine específicos
    # valor_ciudad = "86" corresponde al atributo 'value' de una opción en el menú desplegable de ciudades
    # en el HTML, se verá algo como esto:
    # <select id="ciudad">
    #   <option value="86">Ciudad Ejemplo</option>
    #   <!-- Otras opciones -->
    # </select>
    #
    # valor_cine = "346" corresponde al atributo 'value' de una opción en el menú desplegable de cines
    # en el HTML, se verá algo como esto:
    # <select id="cine">
    #   <option value="346">Cine Ejemplo</option>
    #   <!-- Otras opciones -->
    # </select>

    nombre_cine = elegir_ciudad_cine(driver, espera, "86", "346")

   # Se imprime el nombre del cine seleccionado para confirmación.
    print(f"\n\n\n\n\n\nNOMBRE DEL CINE SELECCIONADO (1/4): {nombre_cine}.")
...
#2  #Cinépolis Multiplaza San Salvador
    ...
    # </select>
    #
    # valor_cine = "193" corresponde al atributo 'value' de una opción en el menú desplegable de cines.
    # En el código HTML se verá algo como esto:
    # <select id="cine">
    #   <option value="193">Cine Ejemplo</option>
    #   <!-- Otras opciones -->
    # </select>

    nombre_cine = elegir_ciudad_cine(driver, espera, "86", "193")


   # Se imprime el nombre del cine seleccionado para confirmación.
    print(f"\n\n\n\n\n\nNOMBRE DEL CINE SELECCIONADO (2/4): {nombre_cine}.")
...
#3  #Cinépolis VIP Galerías San Salvador

    # Crea una instancia de WebDriverWait con un tiempo de espera máximo de 10 segundos.
    espera = WebDriverWait(driver, 10)

    # Llamada a la función elegir_ciudad_cine para seleccionar una ciudad y un cine específicos
    # valor_ciudad = "86" y valor_cine = "583" son valores que corresponden a los atributos 'value'
    ...
    # <select id="ciudad">
    #   <option value="86">Nombre de la Ciudad</option>
    #   <!-- Otras opciones -->
    # </select>

    # Y el menú desplegable para seleccionar el cine puede verse así:
    # <select id="cine">
    #   <option value="583">Nombre del Cine</option>
    #   <!-- Otras opciones -->
    # </select>
    ...
    nombre_cine = elegir_ciudad_cine(driver, espera, "86", "583")

   # Se imprime el nombre del cine seleccionado para confirmación.
    print(f"\n\n\n\n\n\nNOMBRE DEL CINE SELECCIONADO (3/4): {nombre_cine}.")
...
#4  #Cinépolis Metrocentro Santa Ana
    
    # Crea una instancia de WebDriverWait con un tiempo de espera máximo de 10 segundos.
    espera = WebDriverWait(driver, 10)

    # Llamada a la función elegir_ciudad_cine para seleccionar una ciudad y un cine específicos.
    # valor_ciudad = "87" y valor_cine = "245" son valores que corresponden a los atributos 'value'
    # de las opciones dentro de los menús desplegables en el HTML de la página web.

    # En el HTML, el menú desplegable para seleccionar la ciudad podría verse así:
    # <select id="ciudad">
    #   <option value="87">Nombre de la Ciudad</option>
    #   <!-- Otras opciones -->
    # </select>

    # Y el menú desplegable para seleccionar el cine podría verse así:
    # <select id="cine">
    #   <option value="245">Nombre del Cine</option>
    #   <!-- Otras opciones -->
    # </select>
    ...
    nombre_cine = elegir_ciudad_cine(driver, espera, "87", "245")


    # Se imprime el nombre del cine seleccionado para confirmación.
    print(f"\n\n\n\n\n\nNOMBRE DEL CINE SELECCIONADO (4/4): {nombre_cine}.")
...
# el código dentro del bloque 'finally' siempre se ejecutará al final.
    ...
    # El nombre del archivo tendrá el formato "CINEPOLIS-EL-SALVADOR-YYYY-MM-DD.xlsx", donde YYYY-MM-DD es la fecha actual.
    # Por ejemplo, si hoy es el 12 de agosto de 2024, el nombre del archivo será "CINEPOLIS-EL-SALVADOR-2024-08-12.xlsx".
    nombre_archivo = f"CINEPOLIS-EL-SALVADOR-{datetime.now().strftime('%Y-%m-%d')}.xlsx"
